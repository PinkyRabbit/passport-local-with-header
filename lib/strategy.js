...
function LocalStrategyWithHeaders(options, verify) {
  ...
  this._headersNames = options.headersNames || [{ name: 'companyid', isNumber: true }];
  this._headersCanBeNull = !!options.headersCanBeNull || false;
...
LocalStrategyWithHeaders.prototype.authenticate = function authenticate(req, options) {
  ...
  var headers = helpers.extractHeaders(req, this._headersNames, this._headersCanBeNull);
